...
import { getSummaryPaths, genNode } from './utils'
...
export default class GitbookView {
  ...
  updateToc () {
    ...
    const bookRoot = getBookRoot(atom.project.getPaths()[0])
    ...
    projectNode.appendChild(bookRoot)
    projectNode.appendChild(chapterTree)
    projectsNode.appendChild(projectNode)
    bookview.appendChild(projectsNode)
  }
}
...
function getBookRoot (projectRoot) {
